...
class depositFormController {
    ...
    constructor($scope, depositService, userService, domFactory, loadingFrameService, popupsService, localStorageService, $timeout, countriesService, $state,$cookies,requestHandlerService,$location) {
    ...
    submit(form) {        
        ...
        this.depositService.depositingCreditCard(params, popupSettings).then(success);
    }
